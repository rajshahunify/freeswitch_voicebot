...
# DF_COMPENSATE_DELAY = True  # Compensate for processing delay
# DF_ATTENUATION_LIMIT = 100  # dB - maximum noise reduction
# DF_ATTENUATION_LIMIT=6.0
# DF_GAIN=1.05
# DF_DEBUG_RMS=True
# DF_DEBUG_SAVE_PATH="/mnt/c/Users/unify/freeswitch_voicebot/nc_debug/"
# # Performance
# DF_USE_GPU = False  # Set to True if CUDA available in WSL
...
# VAD_THRESHOLD = 0.25 # Speech probability threshold (VERY LOW - no NC preprocessing)
...
# # Audio buffering
# # MIN_AUDIO_LENGTH_BYTES = 32000  # ~1 second at 16kHz mono int16
# MIN_AUDIO_LENGTH_BYTES = 4800  # ~0.3 second at 16kHz mono int16
# MAX_AUDIO_LENGTH_BYTES = 320000  # ~10 seconds (prevent memory issues)

# # Buffer timeout
# BUFFER_TIMEOUT_SECONDS = 12  # Force processing after this time
